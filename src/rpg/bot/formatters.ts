import type { CatalogItem, Family, InventoryEntry, PlayerProfile } from "../domain/types";
...
export const formatItemCard = (item: CatalogItem): string => {
  const transport = item.transport;
...
export const formatInventoryEntry = (item: CatalogItem, entry: InventoryEntry): string => [
