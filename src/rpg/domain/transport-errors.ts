...
const definitions: Readonly<Record<TransportErrorCode, { message: string; localizationKey: string; retryable: boolean }>> = {
  TRANSPORT_CAPABILITY_CODE_INVALID: {
...
export const TransportErrorFactory = Object.freeze({
  create(
    code: TransportErrorCode,
    details: Readonly<Record<string, string | number | boolean>> = {}
  ): DomainError {
    const definition = definitions[code];
    return new DomainError(definition.message, code, {
