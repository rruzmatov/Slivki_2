...
// ===== Оральные =====
"засосать": { emoji: "😈", customEmojiId: PREMIUM_EMOJI.rp_ukusit, actionText: "засосал" },
"отсосать": { emoji: "😈", customEmojiId: PREMIUM_EMOJI.rp_ukusit, actionText: "отсосал" },
"соснуть": { emoji: "😈", customEmojiId: PREMIUM_EMOJI.rp_ukusit, actionText: "соснул" },
"взять в рот": { emoji: "😈", customEmojiId: PREMIUM_EMOJI.rp_ukusit, actionText: "взял в рот" },
"взять глубоко": { emoji: "😈", customEmojiId: PREMIUM_EMOJI.rp_ukusit, actionText: "взял глубоко" },
"глубоко засосать": { emoji: "😈", customEmojiId: PREMIUM_EMOJI.rp_ukusit, actionText: "глубоко засосал" },
"отсосать до конца": { emoji: "😈", customEmojiId: PREMIUM_EMOJI.rp_ukusit, actionText: "отсосал до конца" },
"заглотить": { emoji: "😈", customEmojiId: PREMIUM_EMOJI.rp_ukusit, actionText: "заглотил" },
"заглотить до горла": { emoji: "😈", customEmojiId: PREMIUM_EMOJI.rp_ukusit, actionText: "заглотил до горла" },
"сделать минет": { emoji: "😈", customEmojiId: PREMIUM_EMOJI.rp_ukusit, actionText: "сделал минет" },
"отлизать": { emoji: "😈", customEmojiId: PREMIUM_EMOJI.rp_ukusit, actionText: "отлизал" },
"вылизать": { emoji: "😈", customEmojiId: PREMIUM_EMOJI.rp_ukusit, actionText: "вылизал" },
"полизать": { emoji: "😈", customEmojiId: PREMIUM_EMOJI.rp_ukusit, actionText: "полизал" },
"лизнуть": { emoji: "😈", customEmojiId: PREMIUM_EMOJI.rp_ukusit, actionText: "лизнул" },
"полизать киску": { emoji: "😈", customEmojiId: PREMIUM_EMOJI.rp_ukusit, actionText: "полизал киску" },
"отлизать киску": { emoji: "😈", customEmojiId: PREMIUM_EMOJI.rp_ukusit, actionText: "отлизал киску" },
"вылизать киску": { emoji: "😈", customEmojiId: PREMIUM_EMOJI.rp_ukusit, actionText: "вылизал киску" },
"полизать жопу": { emoji: "😈", customEmojiId: PREMIUM_EMOJI.rp_ukusit, actionText: "полизал жопу" },
"отлизать жопу": { emoji: "😈", customEmojiId: PREMIUM_EMOJI.rp_ukusit, actionText: "отлизал жопу" },
"вылизать жопу": { emoji: "😈", customEmojiId: PREMIUM_EMOJI.rp_ukusit, actionText: "вылизал жопу" },
"сделать куни": { emoji: "😈", customEmojiId: PREMIUM_EMOJI.rp_ukusit, actionText: "сделал куни" },
"сделать римминг": { emoji: "😈", customEmojiId: PREMIUM_EMOJI.rp_ukusit, actionText: "сделал римминг" },
" пососать яйца": { emoji: "😈", customEmojiId: PREMIUM_EMOJI.rp_ukusit, actionText: "пососал яйца" },
"лизнуть головку": { emoji: "😈", customEmojiId: PREMIUM_EMOJI.rp_ukusit, actionText: "лизнул головку" },
"облизать": { emoji: "😈", customEmojiId: PREMIUM_EMOJI.rp_ukusit, actionText: "облизал" },
"облизать член": { emoji: "😈", customEmojiId: PREMIUM_EMOJI.rp_ukusit, actionText: "облизал член" },
"облизать киску": { emoji: "😈", customEmojiId: PREMIUM_EMOJI.rp_ukusit, actionText: "облизал киску" },
"сосать медленно": { emoji: "😈", customEmojiId: PREMIUM_EMOJI.rp_ukusit, actionText: "сосёт медленно" },
"сосать быстро": { emoji: "😈", customEmojiId: PREMIUM_EMOJI.rp_ukusit, actionText: "сосёт быстро" },
"сосать глубоко": { emoji: "😈", customEmojiId: PREMIUM_EMOJI.rp_ukusit, actionText: "сосёт глубоко" },
"сосать с языком": { emoji: "😈", customEmojiId: PREMIUM_EMOJI.rp_ukusit, actionText: "сосёт с языком" },
"сосать слюняво": { emoji: "😈", customEmojiId: PREMIUM_EMOJI.rp_ukusit, actionText: "сосёт слюняво" },
"сосать до слёз": { emoji: "😈", customEmojiId: PREMIUM_EMOJI.rp_ukusit, actionText: "сосёт до слёз" },
"сосать до стонов": { emoji: "😈", customEmojiId: PREMIUM_EMOJI.rp_ukusit, actionText: "сосёт до стонов" },
"заставить отсосать": { emoji: "😈", customEmojiId: PREMIUM_EMOJI.rp_ukusit, actionText: "заставил отсосать" },
"заставить взять в рот": { emoji: "😈", customEmojiId: PREMIUM_EMOJI.rp_ukusit, actionText: "заставил взять в рот" },
"заставить заглотить": { emoji: "😈", customEmojiId: PREMIUM_EMOJI.rp_ukusit, actionText: "заставил заглотить" },
"кончить в рот": { emoji: "💦", customEmojiId: PREMIUM_EMOJI.rp_ukusit, actionText: "кончил в рот" },
"кончить на язык": { emoji: "💦", customEmojiId: PREMIUM_EMOJI.rp_ukusit, actionText: "кончил на язык" },
"кончить на лицо после минета": { emoji: "💦", customEmojiId: PREMIUM_EMOJI.rp_ukusit, actionText: "кончил на лицо после минета" },
"заставить глотать сперму": { emoji: "💦", customEmojiId: PREMIUM_EMOJI.rp_ukusit, actionText: "заставил глотать сперму" },
"держать во рту": { emoji: "😈", customEmojiId: PREMIUM_EMOJI.rp_ukusit, actionText: "держит во рту" },
"не вынимать изо рта": { emoji: "😈", customEmojiId: PREMIUM_EMOJI.rp_ukusit, actionText: "не вынимает изо рта" },
"чпокнуть": { emoji: "🍑", customEmojiId: PREMIUM_EMOJI.hit, actionText: "чпокнул" },
