...
exports.achievements = exports.travelLocations = exports.jobs = exports.catalogItems = void 0;
const resalePrice = (price) => Math.floor(price * 0.6);
const repairCost = (price) => Math.max(0, Math.floor(price * 0.08));
const transportItem = (seed) => ({
    id: seed.id,
